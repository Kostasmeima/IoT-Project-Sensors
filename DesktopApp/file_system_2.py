# File: file_system_2.py
# Description: Sample code for Week 5 Task 2
...
class MainApp(IoTApp):
    ...
    def init(self):
        ...
        # Counter to count 10 sensor data readings written to data.csv file 
        self.count = 0
    ...
    def loop(self):
        ...
        if self.sensor_bme680.get_sensor_data():
            ...
            # Write the current BME680 data to a single line in the data.csv file with each sensor value
            ...
            data_line = "{0:.2f},{1:.0f},{2:.2f},{3:.0f}\n".format(tm_reading, pa_reading, rh_reading, gr_reading)
            
            # Write data line to the data.csv file
        ...
        # Try to take readings once every second or so
        sleep(1)
    ...
    def deinit(self):
        ...
        """
        # Make sure the data.csv file is closed
        self.file.close()
...
def main():
    ...
    # property values:-
    #
    #   name: "File Sys 2", this should be a maximum of 14 characters else it is truncated
    ...
    #
    app = MainApp(name="File Sys 2", has_oled_board=True, finish_button="C", start_verbose=True)

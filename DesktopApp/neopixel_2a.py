# File: neopixel_2a.py
# Description: Sample code for Week 3 Task 2a 
...
def main():
    ...
    # Draw left side of box in red (10, 0, 0)
    npm[8] = (10, 0, 0)
    npm[16] = (10, 0, 0)
    npm[24] = (10, 0, 0)
    
    # Draw top side of box in green (0, 10, 0)
    for i in range(7):
        npm[i] = (0, 10, 0)
    
    # Draw right side of box in blue (0, 0, 10)
    npm[7] = (0, 0, 10)
    npm[15] = (0, 0, 10)
    npm[23] = (0, 0, 10)
    
    # Draw bottom side of box in muted white (10, 10, 10)

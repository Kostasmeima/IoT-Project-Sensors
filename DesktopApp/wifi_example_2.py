# File: wifi_example_2.py
# Description: Example code to connect the Huzzah32 to the WLAN using Wi-Fi by way
#              of the IoTApp convenience methods
...
def main():
    ...
    # property values:-
    #
    #   name: "WiFi Example 2", this should be a maximum of 14 characters else it is truncated
    ...
    #
    app = MainApp(name="WiFi Example 2", has_oled_board=True, finish_button="C", start_verbose=True)
